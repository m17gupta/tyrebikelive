import { type Country } from "@/utilities/countryListStub";
...
import { getPayload } from "@/utilities/payloadStub";

export async function POST(req: Request) {
  const { getCouriersArray } = await import("@/utilities/couriersStub");
  try {
